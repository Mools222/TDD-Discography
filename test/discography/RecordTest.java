...
public class RecordTest {
    ...
    public void testCreateRecord() {
        Record record = new Record("Under Production", LocalDate.of(2074, Month.OCTOBER, 6), "single");
    ...
    public void testCreateAlbum() {
        Record record = new Record("Close to the Edge", LocalDate.of(1972, Month.SEPTEMBER, 13), "album", new Track("And You and I", 10, 8), new Track("America", 4, 12, true));
